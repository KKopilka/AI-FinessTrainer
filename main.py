...
import numpy as np
from ai_trainer.feedback.front_squat import give_feedback_front_squat
from ai_trainer.drawing import *
from ai_trainer.properties import *
import argparse
from ai_trainer.feedback.push_up import give_feedback_push_up
...
while cap.isOpened():
    ...
    if success:
        ...
        feedback, possible_corrections, count = exercise_feedback_func(pose_3d, count)
        offset = 0
