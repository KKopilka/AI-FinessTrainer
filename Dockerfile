...
RUN apt-get install -y --no-install-recommends --fix-missing \  
        libgtk-3-dev libjpeg-dev libjpeg62-turbo-dev liblapack-dev \
        liblapacke-dev libopenblas-dev libopencv-dev libpng-dev libpostproc-dev \
        libpq-dev libsm6 libswscale-dev libtbb-dev libtbbmalloc2 libtesseract-dev \
...
ENTRYPOINT ["streamlit", "run", "/streamlit/app/live.py", "--server.port=8501", "--server.address=0.0.0.0"]